...
const Main = () => {
    ...
    useEffect(() => {
        setServices([
            ...
            { name: 'Транслингвальная стимуляция', text: 'Транслингвальная стимуляция. Транслингвальная стимуляция- процедура, представляющая собой одновременное проведение электростимуляции специальным электродом , который накладывается на верхнюю поверхность языка и выполнение комплекса упражнений, направленных на обучение новым двигательным навыкам или восстановление утраченных точно координируемых движений. ... речевые нарушения. нарушения координированных движений (атаксия, дистония и др.) В чем состоит суть метода? Язык – это орган, имеющий наибольшую плотность рецепторов. В основном это рецепторы вкусовой чувственности (ветвь лицевого нерва) и общей чувствительности (ветвь тройничного нерва).' },
                                        ...
                                        <div className='GalleryPhoto' key={i}>
                                            <div className='PhotoSlider'>
                                                ...
                                                <div className='PhotoBox'>
                                                    <img src={photo.link} alt="Фотогалерея" />
                                                </div>
